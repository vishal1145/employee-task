...
export default function Empdetails() {
  ...
  //     let result = await fetch(`http://localhost:5000/deletetask/${id}`, {
  //       method: "Delete",
  //       headers: {
  //         // authorization: `bearer ${JSON.parse(localStorage.getItem('token'))}`
  //       },
  ...
  return (
    <>
      <div className="empdeatils wid-80">
        ...
        <div className="addtaskbtn" style={{position:"fixed", bottom:'10%', right:"1.5%"}}>
          <NavLink className="btn btn-outline-primary" to={"/adddetails"}>
            Add Task
          </NavLink>
        </div>
          ) : null
