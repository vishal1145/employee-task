    ...
    <>
      <div className="addform">
        ...
        <form>
          ...
          <textarea type="text" class="form-control" id="addtask" value={task} onChange={(e)=>setTask(e.target.value)} placeholder='Add Task Here' required />

          <label for="timeduration" class="form-label">
            Time Duration
          </label>
          <input type="text" class="form-control" id="timeduration" value={time} onChange={(e)=>setTime(e.target.value)} placeholder='Time Duration' required />
